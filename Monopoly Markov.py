...
# Groups
stateGroup = ['GO','1','comChest','1','tax','RR','2','chance','2','2',
             'jail','3','utility','3','3','RR','4','comChest','4','4',
             'free','5','chance','5','5','RR','6','6','utility','6',
             'N/a','7','7','comChest','7','RR','chance','8','tax','8',
             'jail','jail']
## Corners: GO, free, jail, N/a=gotojail(impossible)
## Pay Bank: tax, utility
## Draw Card: comChest=community chest,chance
## Properties: RR=railroad, 1=brown,2=teal,3=pink,4=orange,5=red,6=yellow,7=green,8=blue
...
df_goSquareProbabilities.index += 1
